  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-blue-50 to-white py-10">
      <div className="bg-white shadow-xl rounded-lg p-10 max-w-lg w-full text-center">
        ...
        <div className="border rounded-lg mb-6 p-6 bg-gradient-to-r from-blue-50 to-white shadow-sm flex justify-between items-center">
          <p className="text-gray-800 text-md font-semibold">Workspace Name</p>
        ...
        <div>
          ...
          <div className="border rounded-lg mb-6 p-6 bg-gradient-to-r from-green-50 to-white shadow-sm">
            ...
            <button className="w-full py-3 bg-green-600 text-white font-semibold rounded-md hover:bg-green-700 transition-all transform hover:scale-104 duration-300 ease-in-out">
              <Link href="/dashboard/new-workspace">Create Workspace</Link>
            </button>
          </div>
        </div>
