...
const SignupPage = () => {
  ...
  const [renderDifferentSignup, setRenderDifferentSignup] = useState(false);
  ...
  const handleVerificationProp = (booleanValue) => {
    setRenderDifferentSignup(booleanValue);
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  <div>
                    <input
                      ...
                      onBlur={handleBlur}
                      className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-1  ${errors.email && touched.email
