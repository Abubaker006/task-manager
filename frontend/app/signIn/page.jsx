                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div>
                        <input
                            ...
                            onChange={handleChange}
                            onBlur={handleBlur}
                            className={`w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1  ${errors.password && touched.password ? "focus:ring-red-500 border-red-400" : "focus:ring-blue-500 border-gray-300"}`}
                            placeholder="Enter your password"
                            type="password"
                            required
                        />
                        {errors.password && touched.password && (<p className="text-[10px] text-red-600 mt-1 ml-2">*{" "}{errors.password}</p>)}
                    </div>
                    <button
